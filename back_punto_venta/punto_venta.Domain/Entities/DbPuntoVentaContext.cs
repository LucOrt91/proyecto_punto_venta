...
namespace punto_venta.Domain.Entities;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=NIGHTBIRD-S-DES\\LUCAS;DataBase=DB_punto_venta;Trusted_Connection=True;Encrypt=False;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BranchOffice>(entity =>
        {
            entity.HasKey(e => e.BranchOfficeId).HasName("PK__BranchOf__27247FF99F2A4CD0");
        ...
        {
            entity.HasKey(e => e.BusinessId).HasName("PK__Business__F1EAA36E0E76BEF1");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A0BF27A249E");
        ...
        {
            entity.HasKey(e => e.ClientId).HasName("PK__Clients__E67E1A24351BCD4C");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BEDAF5FA14B");
        ...
        {
            entity.HasKey(e => e.DistrictId).HasName("PK__District__85FDA4C6528A3664");
        ...
        {
            entity.HasKey(e => e.DocumentTypeId).HasName("PK__Document__DBA390E101D48F35");
        ...
        {
            entity.HasKey(e => e.MenuId).HasName("PK__Menus__C99ED23073E285F6");
        ...
        {
            entity.HasKey(e => e.MenuRolId).HasName("PK__MenuRole__6640AD0C09BD53A4");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CDC9AF1699");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687DF4B20527");
        ...
        {
            entity.HasKey(e => e.ProvinceId).HasName("PK__Province__FD0A6F832126F5D0");
        ...
        {
            entity.HasKey(e => e.PurcharseId).HasName("PK__Purchars__A98C674B120E7E37");
        ...
        {
            entity.HasKey(e => e.PurcharseDetailId).HasName("PK__Purchars__7353248BC2417A61");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE1A71E08FA8");
        ...
        {
            entity.HasKey(e => e.SaleId).HasName("PK__Sales__1EE3C3FFF527C028");
        ...
        {
            entity.HasKey(e => e.SaleDetailId).HasName("PK__SaleDeta__70DB14FEBD272DE5");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4CF756ED15");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A3563604B2A");
        ...
        {
            entity.HasKey(e => e.UserBranchOfficeId).HasName("PK__UsersBra__7D1E804A107C7261");
